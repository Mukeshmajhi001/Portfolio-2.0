        ...
        <div class="skills-card frontend reveal left">
          ...
          <?php foreach ($front as [$name, $pct, $icon]): ?>
            <div class="skill-item">
              ...
              <div class="skill-bar">
                <div class="skill-fill" data-width="<?= $pct ?>"></div>
              </div>
            </div>
          <?php endforeach; ?>
        </div>
        ...
        <div class="about-text">
          ...
          <div class="achievements reveal">
            <div class="achievement-item">
              ...
              <div>
                <div class="ach-title">Best Developer Award 2023</div>
                <div class="ach-desc">Awarded by TechCorp for exceptional performance</div>
              </div>
            </div>
            <div class="achievement-item">
              <div class="ach-icon">🌟</div>
              <div>
                ...
                <div class="ach-desc">500+ GitHub stars across projects</div>
              </div>
            </div>
            <div class="achievement-item">
              <div class="ach-icon">📝</div>
              <div>
                <div class="ach-title">Tech Blogger</div>
                <div class="ach-desc">10k+ monthly readers on dev.to</div>
              </div>
            </div>
            <div class="achievement-item">
              <div class="ach-icon">🎓</div>
              <div>
                <div class="ach-title">AWS Certified</div>
                <div class="ach-desc">AWS Solutions Architect Associate</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="contact-grid">
        <div class="contact-info reveal left">
          ...
          <div class="contact-items">
            <div class="contact-item">
              ...
              <div>
                ...
                <div class="ci-val">Mukeshkumarmajhi9806357905@gmail.com</div>
              </div>
            </div>
            <div class="contact-item">
              ...
              <div>
                ...
                <div class="ci-val">+977 9810001001</div>
              </div>
            </div>
            <div class="contact-item">
              ...
              <div>
                ...
                <div class="ci-val">Kathmandu, Nepal</div>
              </div>
            </div>
          </div>
          <div class="hero-socials">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener" class="social-link"><i class="fab fa-linkedin-in"></i></a>
            <a href="https://instagram.com" target="_blank" rel="noopener" class="social-link"><i class="fab fa-instagram"></i></a>
            <a href="https://x.com" target="_blank" rel="noopener" class="social-link"><i class="fab fa-twitter"></i></a>
            <a href="https://whatsapp.com" target="_blank" rel="noopener" class="social-link"><i class="fab fa-whatsapp"></i></a>
            <a href="https://facebook.com" target="_blank" rel="noopener" class="social-link"><i class="fab fa-facebook-f"></i></a>
          </div>
          <div class="map-embed">
            <iframe src="https://www.google.com/maps?q=26.457145,87.296387&z=15&output=embed"
